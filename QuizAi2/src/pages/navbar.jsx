...
const Navbar = () => {
  ...
  return (
    <nav className="bg-[#0B0C10] text-white p-4 flex justify-between items-center shadow-md relative">
      {/* Left - Logo & Name */}
      ...
      {user && (
        <>
          ...
          {/* Mobile Dropdown Menu */}
          {menuOpen && (
            <div className="absolute top-16 left-100 w-1/2 items-center bg-[#0B0C10] text-white p-4 flex flex-col gap-4 md:hidden">
