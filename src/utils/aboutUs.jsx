...
const About = () => {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#FFFFFF] text-center p-6">
        <h1 className="text-4xl font-bold text-[#141414]">About Cognitive Quiz</h1>
